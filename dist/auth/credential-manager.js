...
class CredentialManager {
    ...
    async listProfiles() {
        await this.loadStore();
        return Object.values(this.store.profiles).sort((a, b) => a.name.localeCompare(b.name));
    }
    /**
     ...
     */
    createProfileFromEnv(name, environment = 'development') {
     ...
     */
    async exportToFile(filePath, includeSecrets = false) {
        await this.loadStore();
        const exportData = {
            profiles: {},
