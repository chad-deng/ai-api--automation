...
export interface Operation {
  ...
  tags?: string[];
  parameters?: Parameter[];
  // Additional properties for generator integration
  method?: string;
  path?: string;
...
export class ValidationError extends APITestGeneratorError {
...
export class GenerationError extends APITestGeneratorError {
  constructor(message: string, details?: any) {
...
export class ConfigurationError extends APITestGeneratorError {
  constructor(message: string, details?: any) {
...
export class ParsingError extends APITestGeneratorError {
  constructor(message: string, details?: any) {
...
// Parsing Types for Week 1 Sprint 2
