"""
Test Suite for Update existing product
...
class TestUpdateexistingproduct:
    """
    Comprehensive test suite for Update existing product endpoint
    ...
    @pytest.mark.asyncio
    @pytest.mark.smoke
    async def test_post_update_existing_product_success(
        self, async_client, auth_headers, valid_payload
    ):
        """
        Test successful POST operation on /api/v2/products/{id}
    ...
    async def test_post_update_existing_product_idempotency(
        self, async_client, auth_headers, valid_payload
    ):
        """
    ...
    async def test_post_update_existing_product_invalid_input(
    ...
    @pytest.mark.asyncio
    @pytest.mark.auth
    async def test_post_update_existing_product_unauthorized(
    ...
    @pytest.mark.asyncio
    @pytest.mark.error_handling
    async def test_post_update_existing_product_method_not_allowed(
    ...
    async def test_post_update_existing_product_boundary_cases(
    ...
    async def test_post_update_existing_product_concurrent_requests(
        self, async_client, auth_headers, valid_payload
    ):
        """
    ...
    @pytest.mark.asyncio
    @pytest.mark.headers
    async def test_post_update_existing_product_content_type_validation(
        self, async_client, auth_headers, valid_payload
    ):
        """
    ...
    async def test_post_update_existing_product_rate_limiting(
        self, async_client, auth_headers, valid_payload
    ):
        """
