...
# Basic Concurrency Tests for: Retrieves transaction list with optional filters
# Method: GET
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_transaction_list_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/api/v3/transactions", json=payload, headers=auth_headers)
