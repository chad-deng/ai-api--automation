...
# Basic Concurrency Tests for: Creates a new product
# Method: PUT
...
class TestConcurrencyEndpoint:
    ...
    async def test_create_new_product_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.put("/api/v2/products", json=payload, headers=auth_headers)
