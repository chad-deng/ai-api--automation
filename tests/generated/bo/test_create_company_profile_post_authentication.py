"""
Authentication & Authorization Test Suite for Create company profile
...
class TestCreatecompanyprofileAuthentication:
    """
    ...
    async def test_authentication_required(self, async_client):
        ...
        response = await async_client.post(
            "/api/v3/e-invoice/company-profile",
    ...
    async def test_resource_ownership_validation(self, async_client, valid_token):
        ...
        other_user_resource = "/api/v3/e-invoice/company-profile/other_user_123"
    ...
    async def test_concurrent_session_handling(self, async_client, valid_token):
        ...
        tasks = [
            async_client.post("/api/v3/e-invoice/company-profile", headers=headers)
            for _ in range(5)
        ]
