...
# Basic Concurrency Tests for: Retrieves merchant information for the authenticated business
# Method: GET
# Path: /api/v2/merchant
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_merchant_information_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/api/v2/merchant", json=payload, headers=auth_headers)
