"""
Test Suite for Create new product
...
class TestCreatenewproduct:
    """
    Comprehensive test suite for Create new product endpoint
    ...
    @pytest.mark.asyncio
    @pytest.mark.smoke
    async def test_put_create_new_product_success(
        self, async_client, auth_headers, valid_payload
    ):
        """
        Test successful PUT operation on /api/v2/products
    ...
    async def test_put_create_new_product_idempotency(
        self, async_client, auth_headers, valid_payload
    ):
        """
        Test idempotency of PUT operation
    ...
    async def test_put_create_new_product_invalid_input(
        self, async_client, auth_headers, invalid_payload
    ):
        """
        Test PUT operation with invalid input
    ...
    @pytest.mark.asyncio
    @pytest.mark.auth
    async def test_put_create_new_product_unauthorized(
        self, async_client, valid_payload
    ):
        """
        Test PUT operation without authentication
    ...
    @pytest.mark.asyncio
    @pytest.mark.error_handling
    async def test_put_create_new_product_method_not_allowed(
        self, async_client, auth_headers
    ):
        """
        Test unsupported HTTP methods on /api/v2/products
    ...
    async def test_put_create_new_product_boundary_cases(
        self, async_client, auth_headers, boundary_payloads
    ):
        """
        Test PUT operation with boundary values
    ...
    async def test_put_create_new_product_concurrent_requests(
        self, async_client, auth_headers, valid_payload
    ):
        """
        Test PUT operation under concurrent load
    ...
    @pytest.mark.asyncio
    @pytest.mark.headers
    async def test_put_create_new_product_content_type_validation(
        self, async_client, auth_headers, valid_payload
    ):
        """
        Test PUT operation with different content types
    ...
    async def test_put_create_new_product_rate_limiting(
        self, async_client, auth_headers, valid_payload
    ):
        """
        Test rate limiting on /api/v2/products
