...
# Basic Concurrency Tests for: Initiates export of goods report for specified period
# Method: POST
# Path: /api/v3/stocks/export-goods-report
...
class TestConcurrencyEndpoint:
    ...
    async def test_export_goods_report_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.post("/api/v3/stocks/export-goods-report", json=payload, headers=auth_headers)
