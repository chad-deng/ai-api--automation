"""
Authentication & Authorization Test Suite for Get business Pendo information
...
class TestGetbusinessPendoinformationAuthentication:
    """
    ...
    async def test_resource_ownership_validation(self, async_client, valid_token):
        ...
        other_user_resource = "/api/v2/business/pendo/other_user_123"
    ...
    async def test_concurrent_session_handling(self, async_client, valid_token):
        ...
        tasks = [
            async_client.get("/api/v2/business/pendo", headers=headers)
            for _ in range(5)
        ]
