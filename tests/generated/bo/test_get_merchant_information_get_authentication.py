"""
Authentication & Authorization Test Suite for Get merchant information
...
class TestGetmerchantinformationAuthentication:
    """
    ...
    async def test_resource_ownership_validation(self, async_client, valid_token):
        ...
        other_user_resource = "/api/v2/merchant/other_user_123"
    ...
    async def test_concurrent_session_handling(self, async_client, valid_token):
        ...
        tasks = [
            async_client.get("/api/v2/merchant", headers=headers)
            for _ in range(5)
        ]
