"""
Test Suite for Search purchase orders
Generated by AI API Test Automation Framework
Endpoint: POST /api/v3/inventory/purchase-order/search
...
class TestSearchpurchaseorders:
    """
    Comprehensive test suite for Search purchase orders endpoint
    ...
    def boundary_payloads(self):
        ...
        return [
            ...
            {"query": ""},  # Empty string
            {"query": "x" * 1000},  # Long string
            {"query": "test@#$%^&*()"},  # Special characters
            
            
            
            {"status": ""},  # Empty string
            {"status": "x" * 1000},  # Long string
            {"status": "test@#$%^&*()"},  # Special characters
            
            
            
            {"startDate": ""},  # Empty string
            {"startDate": "x" * 1000},  # Long string
            {"startDate": "test@#$%^&*()"},  # Special characters
            
            
            
            {"endDate": ""},  # Empty string
            {"endDate": "x" * 1000},  # Long string
            {"endDate": "test@#$%^&*()"},  # Special characters
    ...
    @pytest.mark.asyncio
    @pytest.mark.smoke
    async def test_post_search_purchase_orders_success(
        self, async_client, auth_headers, valid_payload
    ):
        """
        Test successful POST operation on /api/v3/inventory/purchase-order/search
        ...
        """
        # Arrange
        endpoint_path = "/api/v3/inventory/purchase-order/search"
    ...
    async def test_post_search_purchase_orders_idempotency(
        self, async_client, auth_headers, valid_payload
    ):
        """
    ...
    async def test_post_search_purchase_orders_invalid_input(
    ...
    @pytest.mark.asyncio
    @pytest.mark.auth
    async def test_post_search_purchase_orders_unauthorized(
    ...
    @pytest.mark.asyncio
    @pytest.mark.error_handling
    async def test_post_search_purchase_orders_method_not_allowed(
        self, async_client, auth_headers
    ):
        """
        Test unsupported HTTP methods on /api/v3/inventory/purchase-order/search
    ...
    async def test_post_search_purchase_orders_boundary_cases(
    ...
    async def test_post_search_purchase_orders_concurrent_requests(
        self, async_client, auth_headers, valid_payload
    ):
        """
    ...
    @pytest.mark.asyncio
    @pytest.mark.headers
    async def test_post_search_purchase_orders_content_type_validation(
        self, async_client, auth_headers, valid_payload
    ):
        """
    ...
    async def test_post_search_purchase_orders_rate_limiting(
        self, async_client, auth_headers, valid_payload
    ):
        """
        Test rate limiting on /api/v3/inventory/purchase-order/search
