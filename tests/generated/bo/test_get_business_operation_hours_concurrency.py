...
# Basic Concurrency Tests for: Retrieves operation hours for the business
# Method: GET
# Path: /api/v2/business/operationHours
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_business_operation_hours_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/api/v2/business/operationHours", json=payload, headers=auth_headers)
