...
# Basic Concurrency Tests for: Retrieves basic information about the authenticated business
# Method: GET
# Path: /api/v2/business/basicInfo
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_basic_business_information_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/api/v2/business/basicInfo", json=payload, headers=auth_headers)
