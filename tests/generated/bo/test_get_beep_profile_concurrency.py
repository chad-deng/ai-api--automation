...
# Basic Concurrency Tests for: Retrieves the Beep profile information for the business
# Method: GET
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_beep_profile_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/api/v2/business/beep-profile", json=payload, headers=auth_headers)
