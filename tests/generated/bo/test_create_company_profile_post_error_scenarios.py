"""
Error Scenarios Test Suite for Create company profile
...
class TestCreatecompanyprofileErrorScenarios:
    """
    Error scenario test suite for Create company profile
    """
    ...
    async def test_not_found(self, async_client, auth_headers):
        """Test 404 Not Found"""
        response = await async_client.post(
            "/api/v3/e-invoice/company-profile/nonexistent_resource_12345",
            headers=auth_headers['valid']
        )
    ...
    async def test_invalid_path_parameters(self, async_client, auth_headers):
        ...
        invalid_paths = [
            "/api/v3/e-invoice/company-profile/../../etc/passwd",  # Path traversal
            "/api/v3/e-invoice/company-profile/<script>alert(1)</script>",  # XSS attempt
            "/api/v3/e-invoice/company-profile/';DROP TABLE users;--",  # SQL injection
        ]
