...
# Basic Concurrency Tests for: Retrieves all stores associated with the authenticated business
# Method: GET
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_business_stores_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/api/v2/business/stores", json=payload, headers=auth_headers)
