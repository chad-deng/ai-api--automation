"""
Authentication & Authorization Test Suite for Health check endpoint
...
class TestHealthcheckendpointAuthentication:
    """
    ...
    async def test_resource_ownership_validation(self, async_client, valid_token):
        ...
        other_user_resource = "/health/other_user_123"
    ...
    async def test_concurrent_session_handling(self, async_client, valid_token):
        ...
        tasks = [
            async_client.get("/health", headers=headers)
            for _ in range(5)
        ]
