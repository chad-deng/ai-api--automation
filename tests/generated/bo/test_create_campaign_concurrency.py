...
# Basic Concurrency Tests for: Creates a new marketing campaign
# Method: POST
...
class TestConcurrencyEndpoint:
    ...
    async def test_create_campaign_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.post("/api/v3/campaign", json=payload, headers=auth_headers)
