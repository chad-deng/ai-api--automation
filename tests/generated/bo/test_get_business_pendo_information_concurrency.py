...
# Basic Concurrency Tests for: Retrieves Pendo analytics information for the authenticated business
# Method: GET
# Path: /api/v2/business/pendo
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_business_pendo_information_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/api/v2/business/pendo", json=payload, headers=auth_headers)
