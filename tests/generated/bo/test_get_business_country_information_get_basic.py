"""
Test Suite for Get business country information
Generated by AI API Test Automation Framework
Endpoint: GET /api/v2/business/country
...
class TestGetbusinesscountryinformation:
    """
    Comprehensive test suite for Get business country information endpoint
    ...
    @pytest.mark.asyncio
    @pytest.mark.smoke
    async def test_get_get_business_country_information_success(
        self, async_client, auth_headers, valid_payload
    ):
        """
        Test successful GET operation on /api/v2/business/country
        ...
        """
        # Arrange
        endpoint_path = "/api/v2/business/country"
        ...
        if response.status_code != 204:  # No content expected for 204
            ...
            if isinstance(response_data, dict):
                ...
                assert "country" in response_data, \
                    f"Response missing required field 'country'"
                
                assert "countryCode" in response_data, \
                    f"Response missing required field 'countryCode'"
                
                assert "currency" in response_data, \
                    f"Response missing required field 'currency'"
    ...
    async def test_get_get_business_country_information_idempotency(
        self, async_client, auth_headers, valid_payload
    ):
        """
    ...
    async def test_get_get_business_country_information_invalid_input(
    ...
    @pytest.mark.asyncio
    @pytest.mark.auth
    async def test_get_get_business_country_information_unauthorized(
    ...
    @pytest.mark.asyncio
    @pytest.mark.error_handling
    async def test_get_get_business_country_information_method_not_allowed(
        self, async_client, auth_headers
    ):
        """
        Test unsupported HTTP methods on /api/v2/business/country
    ...
    async def test_get_get_business_country_information_boundary_cases(
    ...
    async def test_get_get_business_country_information_concurrent_requests(
        self, async_client, auth_headers, valid_payload
    ):
        """
    ...
    @pytest.mark.asyncio
    @pytest.mark.headers
    async def test_get_get_business_country_information_content_type_validation(
        self, async_client, auth_headers, valid_payload
    ):
        """
    ...
    async def test_get_get_business_country_information_rate_limiting(
        self, async_client, auth_headers, valid_payload
    ):
        """
        Test rate limiting on /api/v2/business/country
