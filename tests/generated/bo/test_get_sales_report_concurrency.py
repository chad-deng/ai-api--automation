...
# Basic Concurrency Tests for: Generates a sales report based on the provided filters
# Method: POST
# Path: /api/v2/report/sales
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_sales_report_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.post("/api/v2/report/sales", json=payload, headers=auth_headers)
