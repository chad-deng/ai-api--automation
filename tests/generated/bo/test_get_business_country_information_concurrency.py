...
# Basic Concurrency Tests for: Retrieves country information for the authenticated business
# Method: GET
# Path: /api/v2/business/country
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_business_country_information_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/api/v2/business/country", json=payload, headers=auth_headers)
