...
# Basic Concurrency Tests for: Retrieves subscription information for the authenticated business
# Method: GET
# Path: /api/v3/subscription
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_subscription_information_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/api/v3/subscription", json=payload, headers=auth_headers)
