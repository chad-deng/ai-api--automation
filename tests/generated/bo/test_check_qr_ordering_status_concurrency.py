...
# Basic Concurrency Tests for: Returns whether QR ordering is enabled for the business
# Method: GET
...
class TestConcurrencyEndpoint:
    ...
    async def test_check_qr_ordering_status_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/api/v2/business/qrOrderingEnabled", json=payload, headers=auth_headers)
