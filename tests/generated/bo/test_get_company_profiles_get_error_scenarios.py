"""
Error Scenarios Test Suite for Get company profiles
...
class TestGetcompanyprofilesErrorScenarios:
    """
    Error scenario test suite for Get company profiles
    """
    ...
    async def test_method_not_allowed(self, async_client, auth_headers):
        ...
        response = await async_client.request(
            ...
            "/api/v3/e-invoice/company-profiles",
    ...
    async def test_not_found(self, async_client, auth_headers):
        """Test 404 Not Found"""
        response = await async_client.get(
            "/api/v3/e-invoice/company-profiles/nonexistent_resource_12345",
            headers=auth_headers['valid']
        )
    ...
    async def test_bad_request(self, async_client, auth_headers):
        ...
        response = await async_client.get(
            "/api/v3/e-invoice/company-profiles?invalid_param=value",
            headers=auth_headers['valid']
        )
    ...
    async def test_invalid_path_parameters(self, async_client, auth_headers):
        ...
        invalid_paths = [
            "/api/v3/e-invoice/company-profiles/../../etc/passwd",  # Path traversal
            "/api/v3/e-invoice/company-profiles/<script>alert(1)</script>",  # XSS attempt
            "/api/v3/e-invoice/company-profiles/';DROP TABLE users;--",  # SQL injection
        ]
