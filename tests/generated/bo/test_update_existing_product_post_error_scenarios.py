"""
Error Scenarios Test Suite for Update existing product
...
class TestUpdateexistingproductErrorScenarios:
    """
    Error scenario test suite for Update existing product
    """
