"""
Authentication & Authorization Test Suite for Update existing product
...
class TestUpdateexistingproductAuthentication:
    """
    ...
    async def test_concurrent_session_handling(self, async_client, valid_token):
        ...
        tasks = [
            async_client.post("/api/v2/products/{id}", headers=headers)
            for _ in range(5)
        ]
