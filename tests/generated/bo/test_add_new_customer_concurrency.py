...
# Basic Concurrency Tests for: Creates a new customer record
# Method: POST
# Path: /api/v3/customer/customer
...
class TestConcurrencyEndpoint:
    ...
    async def test_add_new_customer_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.post("/api/v3/customer/customer", json=payload, headers=auth_headers)
