...
# Basic Concurrency Tests for: Retrieves all e-invoice company profiles for the business
# Method: GET
# Path: /api/v3/e-invoice/company-profiles
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_company_profiles_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/api/v3/e-invoice/company-profiles", json=payload, headers=auth_headers)
