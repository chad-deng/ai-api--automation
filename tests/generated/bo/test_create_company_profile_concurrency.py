...
# Basic Concurrency Tests for: Creates a new e-invoice company profile
# Method: POST
# Path: /api/v3/e-invoice/company-profile
...
class TestConcurrencyEndpoint:
    ...
    async def test_create_company_profile_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.post("/api/v3/e-invoice/company-profile", json=payload, headers=auth_headers)
