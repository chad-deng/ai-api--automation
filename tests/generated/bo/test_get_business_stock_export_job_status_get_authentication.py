"""
Authentication & Authorization Test Suite for Get business stock export job status
...
class TestGetbusinessstockexportjobstatusAuthentication:
    """
    ...
    async def test_resource_ownership_validation(self, async_client, valid_token):
        ...
        other_user_resource = "/api/v3/stocks/goods-report-years/other_user_123"
    ...
    async def test_concurrent_session_handling(self, async_client, valid_token):
        ...
        tasks = [
            async_client.get("/api/v3/stocks/goods-report-years", headers=headers)
            for _ in range(5)
        ]
