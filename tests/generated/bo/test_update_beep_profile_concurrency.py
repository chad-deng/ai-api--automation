...
# Basic Concurrency Tests for: Updates the Beep profile information for the business
# Method: POST
# Path: /api/v2/business/beep-profile
...
class TestConcurrencyEndpoint:
    ...
    async def test_update_beep_profile_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.post("/api/v2/business/beep-profile", json=payload, headers=auth_headers)
