...
class TestHealthcheckendpoint:
    """
    Comprehensive test suite for Health check endpoint endpoint
    ...
    @pytest.mark.asyncio
    @pytest.mark.smoke
    async def test_get_health_check_endpoint_success(
        self, async_client, auth_headers, valid_payload
    ):
        """
        Test successful GET operation on /health
    ...
    async def test_get_health_check_endpoint_idempotency(
        self, async_client, auth_headers, valid_payload
    ):
        """
    ...
    async def test_get_health_check_endpoint_invalid_input(
    ...
    @pytest.mark.asyncio
    @pytest.mark.auth
    async def test_get_health_check_endpoint_unauthorized(
    ...
    @pytest.mark.asyncio
    @pytest.mark.error_handling
    async def test_get_health_check_endpoint_method_not_allowed(
    ...
    async def test_get_health_check_endpoint_boundary_cases(
    ...
    async def test_get_health_check_endpoint_concurrent_requests(
        self, async_client, auth_headers, valid_payload
    ):
        """
    ...
    @pytest.mark.asyncio
    @pytest.mark.headers
    async def test_get_health_check_endpoint_content_type_validation(
        self, async_client, auth_headers, valid_payload
    ):
        """
    ...
    async def test_get_health_check_endpoint_rate_limiting(
        self, async_client, auth_headers, valid_payload
    ):
        """
        Test rate limiting on /health
