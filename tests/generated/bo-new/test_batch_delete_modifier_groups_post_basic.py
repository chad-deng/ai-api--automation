"""
Test Suite for Batch delete modifier groups
...
class TestBatchdeletemodifiergroups:
    """
    Comprehensive test suite for Batch delete modifier groups endpoint
    ...
    async def test_post_batch_delete_modifier_groups_success(
