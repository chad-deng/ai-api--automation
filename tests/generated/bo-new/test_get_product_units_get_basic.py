"""
Test Suite for Get product units
Generated by AI API Test Automation Framework
Endpoint: GET /api/v2/product-units
...
class TestGetproductunits:
    """
    Comprehensive test suite for Get product units endpoint
    ...
    async def test_get_get_product_units_success(
