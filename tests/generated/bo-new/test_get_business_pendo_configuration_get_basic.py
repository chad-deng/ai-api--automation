"""
Test Suite for Get business Pendo configuration
...
class TestGetbusinessPendoconfiguration:
    """
    Comprehensive test suite for Get business Pendo configuration endpoint
    ...
    def test_payload(self):
        ...
        return {"test_bool": true, "test_number": 479}
    ...
    async def test_get_get_business_pendo_configuration_success(
