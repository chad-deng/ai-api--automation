"""
Test Suite for Get shared modifier by ID
Generated by AI API Test Automation Framework
Endpoint: GET /api/v3/shared-modifiers/{id}
...
class TestGetsharedmodifierbyID:
    """
    Comprehensive test suite for Get shared modifier by ID endpoint
    ...
    async def test_get_get_shared_modifier_by_id_success(
