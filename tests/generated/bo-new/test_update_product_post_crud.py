"""
CRUD Operations Test Suite for Update product
...
class TestUpdateproductCRUD:
    """
    Enterprise CRUD test suite for Update product
            ...
            if resource_id:
                try:
                    await async_client.delete(
                        f"/api/v2/products/{id}/{resource_id}",
                        headers=auth_headers
                    )
                except:
    ...
    async def test_read_resource_by_id(self, async_client, auth_headers, created_resource):
        ...
        # Arrange
        endpoint = f"/api/v2/products/{id}/{created_resource}"
    ...
    async def test_read_resource_not_found(self, async_client, auth_headers):
        ...
        endpoint = f"/api/v2/products/{id}/{non_existent_id}"
    ...
    async def test_delete_resource_success(self, async_client, auth_headers, create_payload):
        ...
        create_endpoint = "/api/v2/products/{id}"
        ...
        delete_endpoint = f"/api/v2/products/{id}/{resource_id}"
    ...
    async def test_batch_create_resources(self, async_client, auth_headers, batch_payloads):
        ...
        """
        # Arrange
        endpoint = "/api/v2/products/{id}/batch"
    ...
    async def test_batch_delete_resources(self, async_client, auth_headers, batch_payloads):
        ...
        # Arrange
        batch_delete_endpoint = "/api/v2/products/batch"
