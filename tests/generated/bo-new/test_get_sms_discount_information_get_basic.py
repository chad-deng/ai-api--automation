"""
Test Suite for Get SMS discount information
Generated by AI API Test Automation Framework
Endpoint: GET /api/v3/merchant/billing/sms/discountInfos
...
class TestGetSMSdiscountinformation:
    """
    Comprehensive test suite for Get SMS discount information endpoint
    ...
    async def test_get_get_sms_discount_information_success(
        ...
        logger.info("Testing basic success case", 
                   method="GET", 
                   path="/api/v3/merchant/billing/sms/discountInfos")
