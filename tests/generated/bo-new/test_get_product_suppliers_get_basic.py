"""
Test Suite for Get product suppliers
Generated by AI API Test Automation Framework
Endpoint: GET /api/v2/product-suppliers
...
class TestGetproductsuppliers:
    """
    Comprehensive test suite for Get product suppliers endpoint
    ...
    async def test_get_get_product_suppliers_success(
