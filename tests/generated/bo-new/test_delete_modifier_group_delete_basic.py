"""
Test Suite for Delete modifier group
Generated by AI API Test Automation Framework
Endpoint: DELETE /api/v3/shared-modifiers/{id}
...
class TestDeletemodifiergroup:
    """
    Comprehensive test suite for Delete modifier group endpoint
    ...
    async def test_delete_delete_modifier_group_success(
