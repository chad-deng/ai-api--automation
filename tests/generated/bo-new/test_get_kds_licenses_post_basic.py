"""
Test Suite for Get KDS licenses
...
class TestGetKDSlicenses:
    """
    Comprehensive test suite for Get KDS licenses endpoint
    ...
    async def test_post_get_kds_licenses_success(
