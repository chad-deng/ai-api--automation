"""
Authentication & Authorization Test Suite for Get Beep profile
...
class TestGetBeepprofileAuthentication:
    """
    ...
    async def test_concurrent_session_handling(self, async_client, valid_token):
        ...
        tasks = [
            async_client.get("/api/v2/business/beep-profile", headers=headers)
            for _ in range(5)
        ]
