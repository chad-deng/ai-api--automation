"""
Test Suite for Get SMS billing information
Generated by AI API Test Automation Framework
Endpoint: GET /api/v3/merchant/billing/sms
...
class TestGetSMSbillinginformation:
    """
    Comprehensive test suite for Get SMS billing information endpoint
    ...
    async def test_get_get_sms_billing_information_success(
        ...
        logger.info("Testing basic success case", 
                   method="GET", 
                   path="/api/v3/merchant/billing/sms")
