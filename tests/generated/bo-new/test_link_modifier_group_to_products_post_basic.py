"""
Test Suite for Link modifier group to products
...
class TestLinkmodifiergrouptoproducts:
    """
    Comprehensive test suite for Link modifier group to products endpoint
    ...
    async def test_post_link_modifier_group_to_products_success(
        ...
        logger.info("Testing basic success case", 
                   method="POST", 
                   path="/api/v3/products/link-shared-modifier")
