"""
Test Suite for Complete payment
...
class TestCompletepayment:
    """
    Comprehensive test suite for Complete payment endpoint
    ...
    async def test_post_complete_payment_success(
