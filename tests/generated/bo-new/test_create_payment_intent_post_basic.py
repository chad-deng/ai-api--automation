"""
Test Suite for Create payment intent
Generated by AI API Test Automation Framework
Endpoint: POST /api/v3/payment-intent
...
class TestCreatepaymentintent:
    """
    Comprehensive test suite for Create payment intent endpoint
    ...
    async def test_post_create_payment_intent_success(
