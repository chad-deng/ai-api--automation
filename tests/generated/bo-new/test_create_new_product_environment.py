...
# Environment Configuration Tests for: Creates a new product in the catalog
# Method: PUT
...
class TestEnvironmentEndpoint:
    ...
    async def test_create_new_product_env_missing_api_key(self, client, auth_headers, env_backup, temp_config_dir):
        ...
        try:
            ...
            response = await client.put("/api/v2/products", json=payload, headers=auth_headers, timeout=45.0)
    ...
    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_env_missing_database_url(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_env_missing_jwt_secret(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    # CONFIG FILES TESTS\n\n    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_config_missing_config_yaml(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_config_missing_config_json(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_config_missing_app_config(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    # SSL TESTS\n\n    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_ssl_valid_ssl(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_ssl_disabled_ssl(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_ssl_invalid_cert_path(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    # CONNECTIVITY TESTS\n\n    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_connectivity_development(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_connectivity_staging(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_connectivity_production(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    # PERFORMANCE TESTS\n\n    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_timeout_very_short(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_timeout_short(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_timeout_normal(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    # DEPLOYMENT TESTS\n\n    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_deploy_limited_memory(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_deploy_limited_cpu(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_deploy_multiple_replicas(self, client, auth_headers, env_backup, temp_config_dir):
    ...
    @pytest.mark.asyncio
    @pytest.mark.environment
    async def test_create_new_product_environment_summary(self, client, auth_headers, env_backup):
        ...
        try:
            ...
            response = await client.put("/api/v2/products", json=test_payload, headers=auth_headers)
