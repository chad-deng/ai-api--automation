"""
Test Suite for Get group buy details
Generated by AI API Test Automation Framework
Endpoint: GET /group-buys/{id}
...
class TestGetgroupbuydetails:
    """
    Comprehensive test suite for Get group buy details endpoint
    ...
    async def test_get_get_group_buy_details_success(
