"""
Test Suite for Delete merchant address
Generated by AI API Test Automation Framework
Endpoint: DELETE /merchants/addresses/{addressId}
...
class TestDeletemerchantaddress:
    """
    Comprehensive test suite for Delete merchant address endpoint
    ...
    async def test_delete_delete_merchant_address_success(
