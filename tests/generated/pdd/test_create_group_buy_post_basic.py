"""
Test Suite for Create group buy
Generated by AI API Test Automation Framework
Endpoint: POST /master/group-buys
...
class TestCreategroupbuy:
    """
    Comprehensive test suite for Create group buy endpoint
    ...
    async def test_post_create_group_buy_success(
