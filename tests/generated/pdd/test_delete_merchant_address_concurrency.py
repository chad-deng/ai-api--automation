...
# Basic Concurrency Tests for: Delete a delivery address for the merchant
# Method: DELETE
...
class TestConcurrencyEndpoint:
    ...
    async def test_delete_merchant_address_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.delete("/merchants/addresses/{addressId}", json=payload, headers=auth_headers)
