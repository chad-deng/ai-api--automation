...
# Basic Concurrency Tests for: Get list of merchant's orders with pagination
# Method: GET
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_merchant_orders_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/merchants/orders", json=payload, headers=auth_headers)
