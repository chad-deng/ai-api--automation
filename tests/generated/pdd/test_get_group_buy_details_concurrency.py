...
# Basic Concurrency Tests for: Get detailed information about a specific group buy
# Method: GET
# Path: /group-buys/{id}
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_group_buy_details_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/group-buys/{id}", json=payload, headers=auth_headers)
