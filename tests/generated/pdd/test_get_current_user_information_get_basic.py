...
class TestGetcurrentuserinformation:
    """
    Comprehensive test suite for Get current user information endpoint
    ...
    Classification: smoke, api_test, critical
    """
    ...
    async def test_get_get_current_user_information_success(
