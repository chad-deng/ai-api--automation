...
# Basic Concurrency Tests for: Get list of merchant's delivery addresses
# Method: GET
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_merchant_addresses_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/merchants/addresses", json=payload, headers=auth_headers)
