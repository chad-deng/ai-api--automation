...
# Basic Concurrency Tests for: Mark a specific notification as read
# Method: PUT
...
class TestConcurrencyEndpoint:
    ...
    async def test_mark_notification_as_read_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.put("/notifications/{id}/read", json=payload, headers=auth_headers)
