"""
Test Suite for Get order details
Generated by AI API Test Automation Framework
Endpoint: GET /merchants/orders/{orderId}
...
class TestGetorderdetails:
    """
    Comprehensive test suite for Get order details endpoint
    ...
    def test_payload(self):
        ...
        return {"test_bool": true, "test_field": "dOnGuerJBXGUzCGmJoleYNKfipbqcswmvJjjFtJzEmHxIUyoCdXZpYJxpZSftspKbRuaSOYVMRUOlPljnNNJ", "test_number": 644}
    ...
    async def test_get_get_order_details_success(
