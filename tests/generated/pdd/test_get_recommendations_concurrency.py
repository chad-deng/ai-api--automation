...
# Basic Concurrency Tests for: Get AI-powered product recommendations for the current merchant
# Method: GET
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_recommendations_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/recommendations", json=payload, headers=auth_headers)
