...
class TestUserlogout:
    """
    Comprehensive test suite for User logout endpoint
    ...
    def test_payload(self):
        ...
        return {"test_bool": true, "test_field": "fwwyLJZfurSmjxvomWxSCcZRY", "test_number": 949}
    ...
    async def test_post_user_logout_success(
