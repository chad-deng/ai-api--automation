...
# Basic Concurrency Tests for: Get list of available category tags for filtering group buys
# Method: GET
# Path: /group-buys/category-tags
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_category_tags_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/group-buys/category-tags", json=payload, headers=auth_headers)
