"""
Test Suite for Get cron job status
Generated by AI API Test Automation Framework
Endpoint: GET /admin/cron/status
...
class TestGetcronjobstatus:
    """
    Comprehensive test suite for Get cron job status endpoint
    ...
    def test_payload(self):
        ...
        return {"test_bool": true, "test_field": "kMJSFwGOQPDBFiYpDXAUQhNvdoIKghqmRuhGGtdPNuMKTxzETSeYHKSPuYQzqoCgSOUNcGRaWixZwZVTpTTeseIHcGLNweeleEBx", "test_number": 450}
    ...
    async def test_get_get_cron_job_status_success(
