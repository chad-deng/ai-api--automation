...
# Basic Concurrency Tests for: Get list of active group buys with pagination
# Method: GET
# Path: /group-buys
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_group_buy_list_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/group-buys", json=payload, headers=auth_headers)
