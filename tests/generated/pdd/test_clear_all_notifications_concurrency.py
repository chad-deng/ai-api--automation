...
# Basic Concurrency Tests for: Delete all notifications for the current user
# Method: DELETE
# Path: /notifications
...
class TestConcurrencyEndpoint:
    ...
    async def test_clear_all_notifications_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.delete("/notifications", json=payload, headers=auth_headers)
