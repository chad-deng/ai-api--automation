...
# Basic Concurrency Tests for: Get detailed information about a specific order
# Method: GET
# Path: /merchants/orders/{orderId}
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_order_details_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/merchants/orders/{orderId}", json=payload, headers=auth_headers)
