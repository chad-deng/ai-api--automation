...
# Basic Concurrency Tests for: Delete a demand (Merchant can delete own demands, Master can delete any)
# Method: DELETE
# Path: /demands/{id}
...
class TestConcurrencyEndpoint:
    ...
    async def test_delete_demand_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.delete("/demands/{id}", json=payload, headers=auth_headers)
