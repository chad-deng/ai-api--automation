"""
Test Suite for Get group buy list
Generated by AI API Test Automation Framework
Endpoint: GET /group-buys
...
class TestGetgroupbuylist:
    """
    Comprehensive test suite for Get group buy list endpoint
    ...
    async def test_get_get_group_buy_list_success(
