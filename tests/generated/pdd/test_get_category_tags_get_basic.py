"""
Test Suite for Get category tags
Generated by AI API Test Automation Framework
Endpoint: GET /group-buys/category-tags
...
class TestGetcategorytags:
    """
    Comprehensive test suite for Get category tags endpoint
    ...
    async def test_get_get_category_tags_success(
