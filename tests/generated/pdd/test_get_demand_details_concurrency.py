...
# Basic Concurrency Tests for: Get detailed information about a specific demand
# Method: GET
# Path: /demands/{id}
...
class TestConcurrencyEndpoint:
    ...
    async def test_get_demand_details_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.get("/demands/{id}", json=payload, headers=auth_headers)
