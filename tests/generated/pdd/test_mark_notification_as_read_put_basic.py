"""
Test Suite for Mark notification as read
...
class TestMarknotificationasread:
    """
    Comprehensive test suite for Mark notification as read endpoint
    ...
    async def test_put_mark_notification_as_read_success(
