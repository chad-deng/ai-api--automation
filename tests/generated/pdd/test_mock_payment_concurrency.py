...
# Basic Concurrency Tests for: Simulate payment for testing purposes
# Method: POST
...
class TestConcurrencyEndpoint:
    ...
    async def test_mock_payment_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.post("/payment/mock/{orderId}", json=payload, headers=auth_headers)
