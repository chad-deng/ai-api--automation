...
# Basic Concurrency Tests for: Add a new delivery address for the merchant
# Method: POST
# Path: /merchants/addresses
...
class TestConcurrencyEndpoint:
    ...
    async def test_create_merchant_address_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.post("/merchants/addresses", json=payload, headers=auth_headers)
