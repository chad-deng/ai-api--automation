...
class TestGetrecommendations:
    """
    Comprehensive test suite for Get recommendations endpoint
    ...
    def test_payload(self):
        ...
        return {"test_field": "qjkrsWw6SEMCiay0x1BAZOKsLRDlytTN8Wu"}
    ...
    async def test_get_get_recommendations_success(
