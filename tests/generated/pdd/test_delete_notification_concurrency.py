...
# Basic Concurrency Tests for: Delete a specific notification
# Method: DELETE
...
class TestConcurrencyEndpoint:
    ...
    async def test_delete_notification_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.delete("/notifications/{id}", json=payload, headers=auth_headers)
