"""
Test Suite for Clear all notifications
...
class TestClearallnotifications:
    """
    Comprehensive test suite for Clear all notifications endpoint
    ...
    def test_payload(self):
        ...
        return {"test_bool": true, "test_number": 64}
    ...
    async def test_delete_clear_all_notifications_success(
