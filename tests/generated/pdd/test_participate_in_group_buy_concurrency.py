...
# Basic Concurrency Tests for: Join a group buy with specified quantity and delivery address
# Method: POST
# Path: /group-buys/{id}/participate
...
class TestConcurrencyEndpoint:
    ...
    async def test_participate_in_group_buy_basic_concurrency(self, client, auth_headers):
        ...
        async def make_request(user_id: int, request_id: int):
            ...
            try:
                response = await client.post("/group-buys/{id}/participate", json=payload, headers=auth_headers)
