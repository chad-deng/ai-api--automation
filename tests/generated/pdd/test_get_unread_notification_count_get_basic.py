"""
Test Suite for Get unread notification count
...
class TestGetunreadnotificationcount:
    """
    Comprehensive test suite for Get unread notification count endpoint
    ...
    async def test_get_get_unread_notification_count_success(
